...
class FlightCalculator:
    ...
    def verify_weight_limits(
        ...
        taxi_weight = zfw + fuel + payload
        tow = taxi_weight - 300.0  # Subtract 300 kg taxi fuel burn
        is_legal = tow <= mtow
        landing_margin = tow - mlw
        ...
        return {
            ...
            "taxi_weight_kg": taxi_weight,
            "takeoff_weight_kg": tow,
            "max_takeoff_weight_kg": mtow,
            "max_landing_weight_kg": mlw,
            "landing_margin_kg": landing_margin,
...
5. RESTRICTION ON AUTONOMOUS MATH: You are an analyst, not a calculator. You must strictly use the pre-calculated, deterministic weight values provided in your context. Do not perform any mathematical additions, subtractions, or calculations on these weight figures yourself.
